...
public class Alarm : MonoBehaviour
{
    ...
    {
        _perceptionField.OnEnter += OnPerceptionFieldEnter;
        _perceptionField.OnExit += OnPerceptionFieldExit;
    }
    ...
    private void OnPerceptionFieldEnter(Collider2D collider)
    {
    ...
    private void OnPerceptionFieldExit(Collider2D collider)
    {
        if (collider.TryGetComponent(out Thief thief))
